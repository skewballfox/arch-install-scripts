#this is just a slightly modified base group
...
base+=(reflector fish powerpill apparmor firejail networkmanager openresolv)
base+=(dhclient unbound dnscrypt-proxy chrony)
